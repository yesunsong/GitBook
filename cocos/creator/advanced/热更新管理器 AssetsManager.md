...
这篇文档将全面覆盖热更新管理器 AssetsManager 的设计思路，技术细节以及使用方式。由于热更新机制的需求对于开发者来说可能各不相同，在维护过程中开发者也提出了各个层面的各种问题，说明开发者需要充分了解热更新机制的细节才能够定制出符合自己需要的工作流。所以这篇文档比较长，也尽力循序渐进得介绍热更新机制，但是并不会介绍过多使用层面的代码，对于想要先了解具体如何使用热更新机制来更新自己游戏的开发者，可以先尝试我们提供的一个 [简易教程](http://docs.cocos.com/creator/manual/zh/advanced-topics/hot-update.html)。
...
![img](https://gitee.com/nlpleaf/PicGo/raw/master/45bb818575f69ac7a743bfc73c5fdd13)
...
Manifest 文件可以通过 Cocos Creator 热更新范例中的 [Version Generator 脚本](https://github.com/cocos-creator/tutorial-hot-update#使用-version-generator-来生成-manifest-文件) 来自动生成。
...
![img](https://gitee.com/nlpleaf/PicGo/raw/master/c4b7ccb1af431eb6e2eb9305062cb023)
...
![img](https://gitee.com/nlpleaf/PicGo/raw/master/573211b1d71b10392d05e861a0e6a9dc)
