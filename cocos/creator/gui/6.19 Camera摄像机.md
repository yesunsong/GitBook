...
![img](https://gitee.com/nlpleaf/PicGo/raw/master/58a41f7aea9eb52601d5020cc8d937b0)
...
- **cullingMask**
  ...
  ![camera-1](https://gitee.com/nlpleaf/PicGo/raw/master/8da36732feaeb43d6ccc93428bb01a13)

  用户可以通过编辑器菜单栏中的 **项目 -> 项目设置 -> 分组管理** 来添加或者更改分组，这些分组即是对应的 mask。

  ![culling mask](https://gitee.com/nlpleaf/PicGo/raw/master/06237261c417db4442d2f104758c9541)

- **clearFlags**

  指定渲染摄像机时需要做的清除操作。

  ![camera-2](https://gitee.com/nlpleaf/PicGo/raw/master/9d9da579a4b68703a54a1a7609e35f70)

- **rect**

  决定摄像机绘制在屏幕上的哪个区域，便于实现类似小地图那样的 Viewport，值为 0～1。

  ![camera-2](https://gitee.com/nlpleaf/PicGo/raw/master/0a397b964d1382dba5bd4b164a9fd869)
...
如需调节在 **场景编辑器** 中所用的摄像机参数，可参考 [场景摄像机配置面板](https://docs.cocos.com/creator/manual/zh/content-workflow/camera-config.html)。
