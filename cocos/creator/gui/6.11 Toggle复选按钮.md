...
![toggle1](https://gitee.com/nlpleaf/PicGo/raw/master/8c591c67947defdc4216b39ec48ba208)

点击 **属性检查器** 下面的 **添加组件** 按钮，然后从 **UI 组件** 中选择 **Toggle**，即可添加 Toggle 组件到节点上。

Toggle 的脚本接口请参考 [Toggle API](https://docs.cocos.com/creator/api/zh/classes/Toggle.html)。
...
Toggle 的事件回调有二个参数，第一个参数是 Toggle 本身，通过此参数的 isChecked属性可获得当时状态；第二个参数是 customEventData。
...
![toggle-node-tree](https://gitee.com/nlpleaf/PicGo/raw/master/d634f39c6a12a2e897bdd7b1a0cabb08)
